...
for s = 1:1
    ...
    for contrast = 1:3
        ...
        fNameConstrast = ['motor_5mm_std-mot_zstat', num2str(contrast), '_T1.nii.gz'];
        fileContrast = fullfile(dataPath, subject_id, 'fmri_out', fNameConstrast);
    ...
    for i = 1:nSlices
        ...
        md.PatientName = [subject_id '_Test_D4']; % Update when creating new files
        md.PatientID = [subject_id '_Test_D4']; % Update when creating new files
